...
:root {
  ...
  --line-height-fine-print: calc(var(--num-2) / var(--spacer) * 1rlh);

  /* Scale-based sizes */
  --font-size-body-sm: calc(var(--font-size-base) / var(--scale)); /* ~14px */
  --line-height-body-sm: calc(var(--num-2p5) / var(--spacer) * 1rlh);

  --font-size-h3: calc(var(--font-size-base) * var(--scale)); /* ~20.4px */
  --line-height-h3: calc(var(--num-3) / var(--spacer) * 1rlh);

  --font-size-h2: calc(var(--font-size-h3) * var(--scale)); /* ~24.5px */
  --line-height-h2: calc(var(--num-4) / var(--spacer) * 1rlh);

  --font-size-title: calc(var(--font-size-h2) * var(--scale)); /* ~29.4px */
  --line-height-title: calc(var(--num-4) / var(--spacer) * 1rlh);

  --font-size-hero: calc(var(--font-size-title) * var(--scale)); /* ~35.3px */
  --line-height-hero: calc(var(--num-6) / var(--spacer) * 1rlh);

  /* Fallback for browsers without rlh support */
  @supports not (line-height: 1rlh) {
    --line-height-fine-print: calc(var(--num-2) / var(--spacer));
    --line-height-body-sm: calc(var(--num-2p5) / var(--spacer));
    --line-height-h3: calc(var(--num-3) / var(--spacer));
    --line-height-h2: calc(var(--num-4) / var(--spacer));
    --line-height-title: calc(var(--num-4) / var(--spacer));
    --line-height-hero: calc(var(--num-6) / var(--spacer));
  }
  ...
  @media (width >= 768px) {
    ...
    --line-height-h3: calc(var(--num-5) / var(--spacer) * 1rlh);

    @supports not (line-height: 1rlh) {
      --line-height-h3: calc(var(--num-5) / var(--spacer));
    }
  }
}
...
:root {
  ...
  --dim-0plus: calc(var(--spacer) / 6);      /* 4px — для мелких отступов и высоты строки мелких надписей  */
  --dim-1: calc(var(--spacer) / 3);         /* 8px — единица сетки интерфейса */
  --dim-1plus: calc(var(--dim-1) * 1.5); /* 12px — сетка интерфейса */
  --dim-2: calc(var(--dim-1) * 2);     /* 16px */
  --dim-2plus: calc(var(--dim-1) * 2.5); /* 20px */
  --dim-3: calc(var(--dim-1) * 3);     /* 24px = --spacer */
...
body {
  ...
  line-height: var(--spacer); /* 24px */
  color: var(--color-text, #111);
}

/* Межблочные интервалы — 1 строка */
p, ul, ol, blockquote, pre, table {
  margin-block: 0 var(--spacer); /* отступ снизу – 24px */
}
...
.mb-3 { margin-bottom: var(--spacer); } /* 24px */
...
h2, .h2 {
  ...
  margin-top: var(--margin-top-h2, calc(var(--spacer) * 2));
...
h3, .h3 {
  ...
  margin-top: var(--margin-top-h3, calc(var(--spacer) * 2));
