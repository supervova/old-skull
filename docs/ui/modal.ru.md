...
```html
<dialog class="modal" id="my-dialog">
  <article>
    <header>
      <h2>Hello! I'm a modal dialog...</h2>
    </header>
    <div>
      <p>
        <label for="form-my-input">Label</label>
        <input id="form-my-input" name="name" type="text" autofocus placeholder="Label">
      </p>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
    </div>
    <footer class="modal__buttons">
      <button class="btn-close" type="button" data-role="modal-close">Cancel</button>
...
```html
<dialog id="dialog-sample" aria-labelledby="dialog-sample-title" aria-modal="true">
  <h2 id="dialog-sample-title" class="dialog-title">
